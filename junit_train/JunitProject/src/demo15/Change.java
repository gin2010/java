...
public class Change {
	...
	public static String changeNumberRMB(double rmb) {
		...
		if (strRMB.indexOf("点") >= 0) {
			...
			String str1 = strRMB.substring(0, strRMB.indexOf("元") + 1);
			String str2 = strRMB.substring(strRMB.indexOf("元") + 1);
		    System.out.print(str2.charAt(1));
		    if(str2.charAt(1)=='零'){
		    	strRMB = str1 + str2.charAt(0) + "角";
		    }else if (str2.charAt(0)=='零'){
		    	strRMB = str1 + str2.charAt(0) +  str2.charAt(1) + "分";
		    }else{
